...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('signpad.save') }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="signature" name="signed" style="display: none;background:transparent"></textarea>
                            </div>
                            <br/>
    ...
    <script type="text/javascript">
        var sig = $('#sig').signature({background: 'transparent',syncField: '#signature', syncFormat: 'PNG'});
